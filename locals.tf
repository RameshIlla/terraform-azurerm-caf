...
locals {
  ...
  object_id = coalesce(var.logged_user_objectId, var.logged_aad_app_objectId, try(data.azurerm_client_config.current.id, null), try(data.azuread_service_principal.logged_in_app.0.id, null))
